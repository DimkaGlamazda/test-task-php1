...
<body>
    <div class="wrapper">
        ...
        <div class="container">
            <section class="content border-radius">
                <h2>Content</h2>
                <form>
                    <div class="form-item"><select name="userList"></select></div>
                    <div class="form-item">Tittle: <input type="text" name="title"></div>
                    <div class="form-item">Text: <textarea name="content" cols="30" rows="10"></textarea></div>
                    <div class="form-item"><input type="submit" name="createPost" value="Create post"></div>
                </form>
            </section>
    ...
    <script src="js/postFormHandler.js"></script>
</body>
</html>